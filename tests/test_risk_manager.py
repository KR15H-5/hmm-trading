...
if __name__ == '__main__':
    ...
    result = rm.assess(confidence=0.80, volatility=0.03, current_pnl=10.0, session_idx=0)
    ...
    result = rm.assess(confidence=0.35, volatility=0.03, current_pnl=10.0, session_idx=1)
    print(f"Veto: {result['veto']}  Reason: {result['reason']}")
    ...
    for i in range(3):
        result = rm.assess(confidence=0.90, volatility=0.01, current_pnl=10.0, session_idx=2+i)
        print(f"  Session {2+i}: Veto={result['veto']}  Reason={result['reason']}")
    ...
    result = rm.assess(confidence=0.90, volatility=0.01, current_pnl=10.0, session_idx=5)
    print(f"Veto: {result['veto']}  Reason: {result['reason']}")
    assert result['veto'] == False
    ...
    result = rm.assess(confidence=0.85, volatility=0.12, current_pnl=10.0, session_idx=6)
    print(f"Veto: {result['veto']}  Reason: {result['reason']}")
    assert result['veto'] == True
    ...
    rm2.assess(confidence=0.8, volatility=0.02, current_pnl=100.0, session_idx=0)

    result = rm2.assess(confidence=0.8, volatility=0.02, current_pnl=40.0, session_idx=1)
    print(f"Veto: {result['veto']}  Reason: {result['reason']}")
    ...
    result = rm3.assess(confidence=0.10, volatility=0.50, current_pnl=-500.0, session_idx=0)
